...
Each will ultimately be used to infer the Si IV flux of the star, which is the basis of the
...
"""
None of this needs to be edited, and the results do not change between runs 
unless values in the settings file are modified.
It is included here, instead of just giving the results, for transparency.
Values come from Loyd+ 2018.
"""
